...
- Internal pilot readiness now has a single local aggregate, `scripts/qa-internal-pilot-readiness.ps1`, that chains local validation, backend read smoke, optional approved backend signoff, live env role QA, and browser QA.
